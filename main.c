...
//=======================================================================================================================================================
void head(double xi,double fault,int n,double Timer)
{
    printf("x = %lf\n",xi);
    printf("f(x)  = %lf\n",fault);
...
int main()
{
    ...
    case 1://Метод хорд
      ...
      clock_t T2 = clock();
        head(xi,fabs (f(xi)),n,(double)(T2 - T1) / CLOCKS_PER_SEC);
       break;
    case 2:// Метод половинного ділення
      do
      {
        printf("Left limit: \n");
        scanf("%lf",&x1);
      ...
      while ( fabs (f(xi)) > fault );
      clock_t T22 = clock();
     head(xi,fabs (f(xi)),n,(double)(T22 - T11) / CLOCKS_PER_SEC);
      break;
 ...
 if(n==N)
      ...
      while ( fabs (f(xi)) > fault );
      clock_t T222 = clock();
     head(xi,fabs (f(xi)),n,(double)(T222 - T111) / CLOCKS_PER_SEC);
